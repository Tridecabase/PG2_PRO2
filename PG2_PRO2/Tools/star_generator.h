...
class StarGenerator {
public:
    StarGenerator() = default;
    StarGenerator(const StarGenerator&) = delete;
    StarGenerator& operator=(const StarGenerator&) = delete;

    static void DrawStar(float posX, float posY, float radius, float angleOffset, unsigned int color, unsigned int wirecolor, BlendMode current_mode) {
